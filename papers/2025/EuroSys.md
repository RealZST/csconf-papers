...
- [Achilles: Efficient TEE-Assisted BFT Consensus via Rollback Resilient Recovery](https://doi.org/10.1145/3689031.3717457) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3717457)
  Jianyu Niu, Xiaoqing Wen, Guanlong Wu, Shengqi Liu, Jiangshan Yu, Yinqian Zhang
- [Adios to Busy-Waiting for Microsecond-scale Memory Disaggregation](https://doi.org/10.1145/3689031.3717475) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3717475)
  Wonsup Yoon, Jisu Ok, Sue Moon, Youngjin Kwon
- [AlloyStack: A Library Operating System for Serverless Workflow Applications](https://doi.org/10.1145/3689031.3717490) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3717490)
  Jianing You, Kang Chen, Laiping Zhao, Yiming Li, Yichi Chen, Yuxuan Du, Yanjie Wang, Luhang Wen, Keyang Hu, Keqiu Li
- [Atlas: Towards Real-Time Verification in Large-Scale Networks via a Native Distributed Architecture](https://doi.org/10.1145/3689031.3717494) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3717494)
...
- [CacheBlend: Fast Large Language Model Serving for RAG with Cached Knowledge Fusion](https://doi.org/10.1145/3689031.3696098) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3696098)
  Jiayi Yao, Hanchen Li, Yuhan Liu, Siddhant Ray, Yihua Cheng, Qizheng Zhang, Kuntai Du, Shan Lu, Junchen Jiang
- [CAPSys: Contention-aware task placement for data stream processing](https://doi.org/10.1145/3689031.3696085) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3696085)
  Yuanli Wang, Lei Huang, Zikun Wang, Vasiliki Kalavri, Ibrahim Matta
- [Cheetah: Metadata Aggregation for Fast Object Storage without Distributed Ordering](https://doi.org/10.1145/3689031.3696080) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3696080)
...
- [Daredevil: Rescue Your Flash Storage from Inflexible Kernel Storage Stack](https://doi.org/10.1145/3689031.3717482) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3717482)
...
- [eNetSTL: Towards an In-kernel Library for High-Performance eBPF-based Network Functions](https://doi.org/10.1145/3689031.3696094) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3696094)
...
- [Flex: Fast, Accurate DNN Inference on Low-Cost Edges Using Heterogeneous Accelerator Execution](https://doi.org/10.1145/3689031.3696067) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3696067)
  Tanmoy Sen, Haiying Shen, Anand Padmanabha Iyer
- [FlowCheck: Decoupling Checkpointing and Training of Large-Scale Models](https://doi.org/10.1145/3689031.3696088) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3696088)
  Zimeng Huang, Hao Nie, Haonan Jia, Bo Jiang, Junchen Guo, Jianyuan Lu, Rong Wen, Biao Lyu, Shunmin Zhu, Xinbing Wang
- [Fork: A Dual Congestion Control Loop for Small and Large Flows in Datacenters](https://doi.org/10.1145/3689031.3696101) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3696101)
  Yuan Liu, Wenxin Li, Yulong Li, Lide Suo, Xuan Gao, Xin Xie, Sheng Chen, Ziqi Fan, Wenyu Qu, Guyue Liu
- [Garbage Collection Does Not Only Collect Garbage: Piggybacking-Style Defragmentation for Deduplicated Backup Storage](https://doi.org/10.1145/3689031.3717493) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3717493)
  Dingbang Liu, Xiangyu Zou, Tao Lu, Philip Shilane, Wen Xia, Wenxuan Huang, Yanqi Pan, Hao Huang
- [Groot: Graph-Centric Row Reordering with Tree for Sparse Matrix Multiplications on Tensor Cores](https://doi.org/10.1145/3689031.3717460) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3717460)
  YuAng Chen, Jiadong Xie, Siyi Teng, Wenqi Zeng, Jeffrey Xu Yu
- [HawkSet: Automatic, Application-Agnostic, and Efficient Concurrent PM Bug Detection](https://doi.org/10.1145/3689031.3717477) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3717477)
  João Oliveira, João Gonçalves, Miguel Matos
- [Heimdall: Optimizing Storage I/O Admission with Extensive Machine Learning Pipeline](https://doi.org/10.1145/3689031.3717496) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3717496)
...
- [Hey Hey, My My, Skewness Is Here to Stay: Challenges and Opportunities in Cloud Block Store Traffic](https://doi.org/10.1145/3689031.3696068) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3696068)
...
- [Impeller: Stream Processing on Shared Logs](https://doi.org/10.1145/3689031.3717485) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3717485)
  Zhiting Zhu, Zhipeng Jia, Newton Ni, Dixin Tang, Emmett Witchel
- [Improving GPU Sharing Performance through Adaptive Bubbleless Spatial-Temporal Sharing](https://doi.org/10.1145/3689031.3696070) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3696070)
  Shulai Zhang, Quan Chen, Weihao Cui, Han Zhao, Chunyu Xue, Zhen Zheng, Wei Lin, Minyi Guo
- [Introspective Congestion Control for Consistent High Performance](https://doi.org/10.1145/3689031.3696084) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3696084)
  Wanchun Jiang, Haoyang Li, Jia Wu, Kai Wang, Fengyuan Ren, Jianxin Wang
- [JABAS: Joint Adaptive Batching and Automatic Scaling for DNN Training on Heterogeneous GPUs](https://doi.org/10.1145/3689031.3696078) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3696078)
...
- [LOFT: A Lock-free and Adaptive Learned Index with High Scalability for Dynamic Workloads](https://doi.org/10.1145/3689031.3717458) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3717458)
  Yuxuan Mo, Yu Hua
- [Marlin: Enabling High-Throughput Congestion Control Testing in Large-Scale Networks](https://doi.org/10.1145/3689031.3717486) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3717486)
  Yanqing Chen, Li Wang, Jingzhi Wang, Songyue Liu, Keqiang He, Jian Wang, Xiaoliang Wang, Wanchun Dou, Guihai Chen, Chen Tian
- [MEPipe: Democratizing LLM Training with Memory-Efficient Slice-Level Pipeline Scheduling on Cost-Effective Accelerators](https://doi.org/10.1145/3689031.3717469) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3717469)
...
- [Optimizing Task Scheduling in Cloud VMs with Accurate vCPU Abstraction](https://doi.org/10.1145/3689031.3696092) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3696092)
  Edward Guo, Weiwei Jia, Xiaoning Ding, Jianchen Shan
- [Overcoming the Last Mile between Log-Structured File Systems and Persistent Memory via Scatter Logging](https://doi.org/10.1145/3689031.3717488) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3717488)
  Yifeng Zhang, Yanqi Pan, Hao Huang, Yuchen Shan, Wen Xia
- [ParallelEVM: Operation-Level Concurrent Transaction Execution for EVM-Compatible Blockchains](https://doi.org/10.1145/3689031.3696063) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3696063)
  Haoran Lin, Hang Feng, Yajin Zhou, Lei Wu
- [Pegasus: Transparent and Unified Kernel-Bypass Networking for Fast Local and Remote Communication](https://doi.org/10.1145/3689031.3696083) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3696083)
  Dinglan Peng, Congyu Liu, Tapti Palit, Anjo Vahldiek-Oberwagner, Mona Vij, Pedro Fonseca
- [PET: Proactive Demotion for Efficient Tiered Memory Management](https://doi.org/10.1145/3689031.3717471) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3717471)
  Wanju Doh, Yaebin Moon, Seoyoung Ko, Seunghwan Chung, Kwanhee Kyung, Eojin Lee, Jung Ho Ahn
- [Phantom: Virtualizing Switch Register Resources for Accurate Sketch-based Network Measurement](https://doi.org/10.1145/3689031.3696077) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3696077)
...
- [Pre-Stores: Proactive Software-guided Movement of Data Down the Memory Hierarchy](https://doi.org/10.1145/3689031.3696097) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3696097)
  Xiaoxiang Wu, Baptiste Lepers, Willy Zwaenepoel
- [Rakis: Secure Fast I/O Primitives Across Trust Boundaries on Intel SGX](https://doi.org/10.1145/3689031.3696090) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3696090)
  Mansour Alharthi, Fan Sang, Dmitrii Kuvaiskii, Mona Vij, Taesoo Kim
- [Revealing the Unstable Foundations of eBPF-Based Kernel Extensions](https://doi.org/10.1145/3689031.3717497) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3717497)
...
- [SpaceFusion: Advanced Deep Learning Operator Fusion via Space-Mapping Graph](https://doi.org/10.1145/3689031.3696087) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3696087)
...
- [Understanding the Linux Kernel, Visually](https://doi.org/10.1145/3689031.3696095) · [PDF](https://dl.acm.org/doi/pdf/10.1145/3689031.3696095)
